...
// Memoises the promise, not the value, so concurrent callers share one round trip. No
// reset on failure: every caller awaits this at module scope, so a rejection fails init
